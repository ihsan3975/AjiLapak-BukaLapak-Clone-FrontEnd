                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Home')}
                        ...
                        <Image
                            ...
                            source={require('../Assests/images/icon/ic_close_black_24dp.png')}
                        />
                    </TouchableOpacity>
                    ...
                    <IndicatorViewPager
                        ...
                        <View style={{
                            ...
                            <Image style={{
                                height: 100,
                                width: 100,
                            }} source={require('../Assests/images/icon/ic_a.jpg')}/>
                            <Text style={{
                                fontSize: 17,
                                color: '#000000',
                                textAlign: 'center',
                        ...
                        <View style={{
                            ...
                            <Image style={{
                                height: 100,
                                width: 100,
                            }} source={require('../Assests/images/icon/ic_b.jpg')}/>
                            <Text style={{
                                fontSize: 17,
                                color: '#000000',
                                textAlign: 'center',
                        ...
                        <View style={{
                            ...
                            <Image style={{
                                height: 100,
                                width: 100,
                            }} source={require('../Assests/images/icon/ic_c.jpg')}/>
                            <Text style={{
                                fontSize: 17,
                                color: '#000000',
                                textAlign: 'center',
                        ...
                        <View style={{
                            ...
                            <Image style={{
                                height: 100,
                                width: 100,
                            }} source={require('../Assests/images/icon/ic_d.jpg')}/>
                            <Text style={{
                                fontSize: 17,
                                color: '#000000',
                                textAlign: 'center',
